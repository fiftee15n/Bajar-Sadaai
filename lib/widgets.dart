...
extension IconButtonStyleHelper on CustomIconButton {
  ...
  static BoxDecoration get outlineLightGreen => BoxDecoration(
    ...
    boxShadow: [
      BoxShadow(
        color: appTheme.lightGreen50.withOpacity(0.11),
        spreadRadius: 2.h,
        blurRadius: 2.h,
        offset: Offset(0, 4),
      ),
...
extension TextFormFieldStyleHelper on CustomTextFormField {
  ...
  static OutlineInputBorder get outlineBlue => OutlineInputBorder(
    borderRadius: BorderRadius.circular(16.h),
    borderSide: BorderSide(
      color: appTheme.blue400.withOpacity(0.2),
      width: 5,
    ),
  );
}
...
class CustomButtonStyles {
  ...
  static ButtonStyle get outlinePrimaryTL6 => ElevatedButton.styleFrom(
    ...
    shadowColor: theme.colorScheme.primary.withOpacity(0.11),
    elevation: 4,
    padding: EdgeInsets.zero,
  );
}
...
class CustomSearchView extends StatelessWidget {
  ...
  InputDecoration get decoration => InputDecoration(
        ...
        prefixIcon: prefix ??
            Container(
              margin: EdgeInsets.only(top: 4.h, right: 6.h, bottom: 4.h),
...
InputDecoration get decoration => InputDecoration(
hintText: hintText ?? "",
hintStyle: hintStyle ?? CustosTextStyles.bodyLargeManropeGray400,
prefixIcon: prefix,
prefixIconConstraints: prefixConstraints,
suffixIcon: suffix,
suffixIconConstraints: suffixConstraints,
